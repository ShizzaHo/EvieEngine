...
namespace EvieEngine.Einferia
{
    public class EinferiaDialogManager : MonoBehaviour
    {
        ...
        void Start()
        {
            if (defaultDialogName != null) defaultDialogName.textPreprocessor = new Arhion.TMP.Preprocessor();
            if (defaultDialogText != null) defaultDialogText.textPreprocessor = new Arhion.TMP.Preprocessor();
        ...
        public void GenerateAnswerListUI(List<string> answers, Action<string> onAnswerSelected)
        {
            ...
            foreach (string answer in answers)
            {
                ...
                newAnswerItem.GetComponentInChildren<TMPro.TextMeshProUGUI>().textPreprocessor = new Arhion.TMP.Preprocessor();
