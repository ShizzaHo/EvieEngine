...
namespace EvieEngine.GUNSystem
{
    ...
    {
        [Header("Weapon Settings")] public string weaponName = "Unnamed Weapon";
        public Bullet bulletType;

        [HideInInspector] public bool isReloading = false;

        [Header("Ammo Settings")] public int magazineSize = 30;
        public int currentAmmoInMagazine = 30;
        public int totalAmmo = 90;
        public int maxAmmo = 120;
        public float reloadTime = 0;

        [Header("Fire Settings")] public float fireRate = 0.1f;
        public bool allowSpam = true;

        [Header("Recoil Settings")] public Vector2 recoilPerShot = new Vector2(2f, 1f);
        ...
        [HideInInspector] public HandAnimationRegister animation;
